...
public class MainApplication extends JPanel {
    ...
    private static final String STUDENT_PROFILE_PANEL = "Student Profile";
    private static final String TEACHER_LOGIN_PANEL = "Teacher Login";
    private static final String TEACHER_DASHBOARD_PANEL = "Teacher Dashboard";
    ...
    public MainApplication(String role, LoginUI loginUI) {
        ...
        JPanel teacherLoginPanel = createTeacherLoginPanel();

        cardPanel.add(loginPanel, LOGIN_PANEL);
        cardPanel.add(enrollmentPanel, ENROLLMENT_PANEL);
        cardPanel.add(teacherLoginPanel, TEACHER_LOGIN_PANEL);
    ...
    private JPanel createLoginPanel() {
        ...
        loginButton.addActionListener(e -> {
            ...
            if (student != null) {
                ...
                JOptionPane.showMessageDialog(this, "Login successful for " + name + "!", "Success", JOptionPane.INFORMATION_MESSAGE);
                nameField.setText("");
                passwordField.setText("");
                subjectSelection = createSubjectSelectionPanel();
                studentProfile = createStudentProfilePanel();
                cardPanel.add(subjectSelection, SUBJECT_SELECTION_PANEL);
                cardPanel.add(studentProfile, STUDENT_PROFILE_PANEL);
                cardLayout.show(cardPanel, STUDENT_PROFILE_PANEL);
                cardPanel.revalidate();
                cardPanel.repaint();
            } else {
                JOptionPane.showMessageDialog(this, "Invalid credentials. Please try again or enroll.", "Error", JOptionPane.ERROR_MESSAGE);
            }
        });

        JButton cancelButton = createStyledButton("Cancel", buttonColor, buttonHoverColor);
        cancelButton.setAlignmentX(Component.CENTER_ALIGNMENT);
        cancelButton.addActionListener(e -> loginUI.getCardLayout().show(loginUI.getCardPanel(), "Welcome"));
    ...
    private JPanel createEnrollmentPanel() {
        ...
        EnrollmentMechanics mechanics = new EnrollmentMechanics(
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    messageLabel.setText("Enrollment successful! Admin will assign your Student ID.");
                    ...
                    studentProfile = new StudentProfile(MainApplication.this, subjectSelection);
                    cardPanel.add(subjectSelection, SUBJECT_SELECTION_PANEL);
                    cardPanel.add(studentProfile, STUDENT_PROFILE_PANEL);
        ...
        enrollmentUI.getCancelButton().addActionListener(e -> cardLayout.show(cardPanel, LOGIN_PANEL));
    ...
    private StudentProfile createStudentProfilePanel() {
        return new StudentProfile(this, subjectSelection);
    }

    private JPanel createTeacherLoginPanel() {
        return new TeacherUI(this, loginUI);
    }

    public void setTeacherDashboard(DataStore.TeacherData teacher) {
        if (teacherDashboard != null) {
            cardPanel.remove(teacherDashboard);
        }
        teacherDashboard = new TeacherDashboard(this, loginUI, teacher);
        cardPanel.add(teacherDashboard, TEACHER_DASHBOARD_PANEL);
        cardPanel.revalidate();
        cardPanel.repaint();
        cardLayout.show(cardPanel, TEACHER_DASHBOARD_PANEL);
    }
    ...
    public void setEnrolledStudent(StudentData enrolledStudent) {
